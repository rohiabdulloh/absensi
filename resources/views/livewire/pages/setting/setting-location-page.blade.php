<div class="flex flex-col space-y-3"  
    ...
    <x-breadcrumbs>
        ...
        <x-breadcrumbs-link current="true">Lokasi Presensi</x-breadcrumbs-link>
    </x-breadcrumbs>

    <x-page-header>Lokasi Presensi </x-page-header>
    ...
    <x-card class="min-h-full">
        ...
        <div class="col-span-2 mt-4 space-y-4">
            <p class="text-gray-600 dark:text-gray-300">
               Lokasi dapat dipilih pada peta, atau dapat diinputkan longitude dan latitude secara manual.
            </p>
