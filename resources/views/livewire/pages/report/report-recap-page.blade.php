<div class="flex flex-col space-y-3" x-data="{isImportOpen: false}" >
    <x-breadcrumbs>
        ...
        <x-breadcrumbs-link current="true">Rekap Presensi</x-breadcrumbs-link>
    </x-breadcrumbs>

    <x-page-header> Laporan Rekap Presensi
        <x-slot:action>     
        ...
        <x-table>
            <x-slot:thead>
                <x-table-tr>
                    ...
                    <x-table-th>Izin</x-table-th>
                    <x-table-th>Sakit</x-table-th>
                    <x-table-th>Alfa</x-table-th>
                    <x-table-th>Terlambat</x-table-th>
                </x-table-tr>
            </x-slot>
            @forelse($datareport as $data)
                <x-table-tr>
                    ...
                    <x-table-td>{{ $data->izin }}</x-table-td>
                    <x-table-td>{{ $data->sakit }}</x-table-td>
                    <x-table-td>{{ $data->alfa }}</x-table-td>
                    <x-table-td>{{ $data->terlambat }}</x-table-td>
                </x-table-tr>
            @empty
                <x-table-tr>
                    <x-table-td class="text-center" colspan="8">
